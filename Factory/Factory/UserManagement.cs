    ...
    public partial class UserManagement : Form
    {
        ...
        bool save_product_to_DataBase()
        {
            ...
            try
            {
                ...
                string srtSQL = string.Format("insert into tbl_User (userfirstname,userlastname,usermobile,Username,userpassword,usertypeID) values ('{0}','{1}','{2}','{3}','{4}',{5})", fn,ln,mn,un,pw,ut);
                SqlConnection sqlcon = new SqlConnection(strConnection);
                sqlcon.Open();
        ...
        bool update_product_in_DataBase()
        {
            ...
            try
            {
                ...
                string mn = txtMobile.Text.Trim();
                int ut = int.Parse(cmbUserType.SelectedValue.ToString());
                string srtSQL = string.Format("Update tbl_User set userfirstname='{0}',userlastname='{1}',usermobile='{2}' ,Username='{3}' ,userpassword ='{4}' usertypeID={5} where UID={6},", fn, ln, mn, un, pw,ut,ui);                
                SqlConnection sqlcon = new SqlConnection(strConnection);
                sqlcon.Open();
                SqlCommand sqlcmd = new SqlCommand(srtSQL, sqlcon);
                int r = sqlcmd.ExecuteNonQuery();
        ...
        private void dgvUsers_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbUserType.SelectedValue = dgvUsers.CurrentRow.Cells[3].Value.ToString();
        }//dgvUsers_CellClick
        //---------------------------------------------------------------------
    }//public partial class UserManagement : Form
}//Factory
